...
<div class="container">
    ...
    <div class="well">
        ...
        <div class="form-group">
            <input id="radio1" type="radio" name="mode1" value="afterYear" checked> Tapahtuu yhtenä päivänä
            <br/>
            <input id="radio2" type="radio" name="mode2" value="afterYear"> Tapahtuu aikavälillä
        </div>
        ...
        <div class="input-group">
            <input id="field1" type="text" class="form-control" placeholder="Alkamispäivä dd.mm" disabled>
            <span class="input-group-addon">-</span>
            <input id="field2" type="text" class="form-control" placeholder="Loppumispäivä dd.mm" disabled>
        </div>
